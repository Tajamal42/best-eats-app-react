  ...
  return (
    <div className="max-w-[1640px] mx-auto flex justify-between items-center p-4">
        <div className="flex items-center">
            <div onClick={() => setNav(!nav)} className="curson-pointer"><AiOutlineMenu size={30} /></div>
        ...
        <div className='bg-gray-200 rounded-full flex items-center px-2 w-[200px] sm:w-[400px] lg:w-[500px]'>
             ...
             {/* Cart button */}
        <button className='bg-black text-white hidden md:flex items-center p-2 rounded-full'><BsFillCartFill size={20} className='mr-2' /> Cart</button>
        {/* Overlay */}
        {
        ...
        <div className={nav ? 'fixed top-0 left-0 w-[300px] h-screen bg-white z-10 duration-300' : 'fixed top-0 left-[-100%] w-[300px] h-screen bg-white z-10 duration-300' }>
            ...
            <nav>
                <ul className='flex flex-col p-4 text-gray-800'>
                    ...
                    <li className='text-xl py-4 flex'>
                       <MdWallet size={25} className='mr-4' /> Wallet
                    </li>
                    <li className='text-xl py-4 flex'>
